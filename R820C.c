...
UINT8 R828_iniArry[27] = {0x83, 0x32, 0x75, 0xC0, 0x40, 0xD6, 0x6C, 0xF5, 0x53,
					...
					/*     0x17  0x18  0x19  0x1A  0x1B  0x1C  0x1D  0x1E  0x1F                                                    */
#endif
UINT8 R828_ExtraArry[MAX_TUNER_NUM][5]; 
...
UINT8 R828_Arry[MAX_TUNER_NUM][27];
...
static R828_Standard_Type R828_pre_standard[MAX_TUNER_NUM] = {STD_SIZE, STD_SIZE, STD_SIZE, STD_SIZE};
//----------------------------------------------------------//
...
R828_ErrCode R828_Xtal_Check(R828_TUNER_NUM_TYPE R828_Tuner_Num)
{
    ...
    {
          R828_Arry[R828_Tuner_Num][ArrayNum] = R828_iniArry[ArrayNum];
    }

	//cap 30pF & Drive Low
	R828_I2C.RegAddr = 0x10;
	R828_Arry[R828_Tuner_Num][11]    = (R828_Arry[R828_Tuner_Num][11] & 0xF4) | 0x0B ;
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][11];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
	    return RT_Fail;

	//set pll autotune = 128kHz
	R828_I2C.RegAddr = 0x1A;
	R828_Arry[R828_Tuner_Num][21]    = R828_Arry[R828_Tuner_Num][21] & 0xF3;
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][21];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;

	//set manual initial reg = 111111; 
	R828_I2C.RegAddr = 0x13;
	R828_Arry[R828_Tuner_Num][14]    = (R828_Arry[R828_Tuner_Num][14] & 0x80) | 0x7F;
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][14];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;

	//set auto
	R828_I2C.RegAddr = 0x13;
	R828_Arry[R828_Tuner_Num][14]    = (R828_Arry[R828_Tuner_Num][14] & 0xBF);
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][14];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
#endif
	{
		//cap 20pF 
	    R828_I2C.RegAddr = 0x10;
	    R828_Arry[R828_Tuner_Num][11]    = (R828_Arry[R828_Tuner_Num][11] & 0xFC) | 0x02;
	    R828_I2C.Data    = R828_Arry[R828_Tuner_Num][11];
	    if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		    return RT_Fail;
...
#endif
	   {
		   //cap 10pF 
	       R828_I2C.RegAddr = 0x10;
	       R828_Arry[R828_Tuner_Num][11]    = (R828_Arry[R828_Tuner_Num][11] & 0xFC) | 0x01;
	       R828_I2C.Data    = R828_Arry[R828_Tuner_Num][11];
	       if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		       return RT_Fail;
...
#endif 
	      {
		      //cap 0pF 
	          R828_I2C.RegAddr = 0x10;
	          R828_Arry[R828_Tuner_Num][11]    = (R828_Arry[R828_Tuner_Num][11] & 0xFC) | 0x00;
	          R828_I2C.Data    = R828_Arry[R828_Tuner_Num][11];
	          if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		          return RT_Fail;
...
#endif 
			  {
				   //X'tal drive high
	               R828_I2C.RegAddr = 0x10;
	               R828_Arry[R828_Tuner_Num][11]    = (R828_Arry[R828_Tuner_Num][11] & 0xF7) ;
	               R828_I2C.Data    = R828_Arry[R828_Tuner_Num][11];
	               if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
                          return RT_Fail;
...
R828_ErrCode R828_Init(R828_TUNER_NUM_TYPE R828_Tuner_Num)
{
	...
	if(R828_IMR_done_flag[R828_Tuner_Num]==FALSE)
	{
	  ...
	  //{
		 ...
		 R828_ExtraArry[R828_Tuner_Num][0] = 0x00; 
		 R828_ExtraArry[R828_Tuner_Num][1] = 0x31;
		 R828_ExtraArry[R828_Tuner_Num][2] = 0xB8;
		 R828_ExtraArry[R828_Tuner_Num][3] = 0x00;
		 R828_ExtraArry[R828_Tuner_Num][4] = 0x00;
	  //}
	  ...
	  if(R828_IMR(R828_Tuner_Num, 4, TRUE) != RT_Success)
		return RT_Fail;
	...
	R828_pre_standard[R828_Tuner_Num] = STD_SIZE;
...

{
     ...
     R828_Arry[R828_Tuner_Num][0]     = R828_Arry[R828_Tuner_Num][0]  | 0x20;
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][0];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail; 
     //mixer gain mode = manual
     R828_I2C.RegAddr = 0x07;
     R828_Arry[R828_Tuner_Num][2]     = (R828_Arry[R828_Tuner_Num][2] & 0xEF);
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][2];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail;
     //filter corner = lowest
     R828_I2C.RegAddr = 0x0A;
     R828_Arry[R828_Tuner_Num][5]     = R828_Arry[R828_Tuner_Num][5] | 0x0F;
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][5];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail;
     //filter bw=+2cap, hp=5M
     R828_I2C.RegAddr = 0x0B;
     R828_Arry[R828_Tuner_Num][6]    = (R828_Arry[R828_Tuner_Num][6] & 0x90) | 0x60;
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][6];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail;
     //adc=on, vga code mode, gain = 26.5dB  
     R828_I2C.RegAddr = 0x0C;
     R828_Arry[R828_Tuner_Num][7]    = (R828_Arry[R828_Tuner_Num][7] & 0x60) | 0x0B;
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][7];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail;
     //ring clk = on
     R828_I2C.RegAddr = 0x0F;
     R828_Arry[R828_Tuner_Num][10]   &= 0xF7;
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][10];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail;
     //ring power = on
     R828_I2C.RegAddr = 0x18;
     R828_Arry[R828_Tuner_Num][19]    = R828_Arry[R828_Tuner_Num][19] | 0x10;
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][19];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail;
     //from ring = ring pll in
     R828_I2C.RegAddr = 0x1C;
     R828_Arry[R828_Tuner_Num][23]    = R828_Arry[R828_Tuner_Num][23] | 0x02;
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][23];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail;
     //sw_pdect = det3
     R828_I2C.RegAddr = 0x1E;
     R828_Arry[R828_Tuner_Num][25]    = R828_Arry[R828_Tuner_Num][25] | 0x80;
     R828_I2C.Data    = R828_Arry[R828_Tuner_Num][25];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
           return RT_Fail;
	// Set filt_3dB
	//R828_Arry[R828_Tuner_Num][1]  = R828_Arry[R828_Tuner_Num][1] | 0x20;  
	R828_Arry[R828_Tuner_Num][1]  = R828_Arry[R828_Tuner_Num][1] & 0xDF;  
	R828_I2C.RegAddr  = 0x06;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][1];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
R828_ErrCode R828_IMR(R828_TUNER_NUM_TYPE R828_Tuner_Num, UINT8 IMR_MEM, BOOL IM_Flag)
{
	...
	R828_Arry[R828_Tuner_Num][19] &= 0xF0;      //set ring[3:0]
	R828_Arry[R828_Tuner_Num][19] |= n_ring;
	RingVCO = (16+n_ring)* 8 * RingRef;
	R828_Arry[R828_Tuner_Num][19]&=0xDF;   //clear ring_se23	
	R828_Arry[R828_Tuner_Num][20]&=0xFC;   //clear ring_seldiv	
	R828_Arry[R828_Tuner_Num][26]&=0xFC;   //clear ring_att

	switch(IMR_MEM)
	{
	case 0:
		RingFreq = RingVCO/48;
		R828_Arry[R828_Tuner_Num][19]|=0x20;  // ring_se23 = 1
		R828_Arry[R828_Tuner_Num][20]|=0x03;  // ring_seldiv = 3		
		R828_Arry[R828_Tuner_Num][26]|=0x02;  // ring_att 10
		R828_Arry[R828_Tuner_Num][2] = (R828_Arry[R828_Tuner_Num][2] & 0xE0) | 0x05;
		break;
	case 1:
		RingFreq = RingVCO/16;
		R828_Arry[R828_Tuner_Num][19]|=0x00;  // ring_se23 = 0
		R828_Arry[R828_Tuner_Num][20]|=0x02;  // ring_seldiv = 2		
		R828_Arry[R828_Tuner_Num][26]|=0x00;  // pw_ring 00
		R828_Arry[R828_Tuner_Num][2] = (R828_Arry[R828_Tuner_Num][2] & 0xE0) | 0x05;
		break;
	case 2:
		RingFreq = RingVCO/8;
		R828_Arry[R828_Tuner_Num][19]|=0x00;  // ring_se23 = 0
		R828_Arry[R828_Tuner_Num][20]|=0x01;  // ring_seldiv = 1		
		R828_Arry[R828_Tuner_Num][26]|=0x03;  // pw_ring 11
		R828_Arry[R828_Tuner_Num][2] = (R828_Arry[R828_Tuner_Num][2] & 0xE0) | 0x05;
		break;
	case 3:
		RingFreq = RingVCO/6;
		R828_Arry[R828_Tuner_Num][19]|=0x20;  // ring_se23 = 1
		R828_Arry[R828_Tuner_Num][20]|=0x00;  // ring_seldiv = 0		
		R828_Arry[R828_Tuner_Num][26]|=0x03;  // pw_ring 11
		R828_Arry[R828_Tuner_Num][2] = (R828_Arry[R828_Tuner_Num][2] & 0xE0) | 0x05;
		break;
	case 4:
		...
		R828_Arry[R828_Tuner_Num][19]|=0x00;  // ring_se23 = 0
		R828_Arry[R828_Tuner_Num][20]|=0x00;  // ring_seldiv = 0		
		R828_Arry[R828_Tuner_Num][26]|=0x00;  // pw_ring: min
		R828_Arry[R828_Tuner_Num][2] = (R828_Arry[R828_Tuner_Num][2] & 0xE0) | 0x0A;
		break;
	default:
		RingFreq = RingVCO/4;
		R828_Arry[R828_Tuner_Num][19]|=0x00;  // ring_se23 = 0
	...
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][20];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	//------------pw_ring-------------------//
	R828_I2C.RegAddr = 0x1f;
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][26];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
if ((Rafael_Chip==R620D) || (Rafael_Chip==R828D) || (Rafael_Chip==R828))  //X'tal can't not exceed 20MHz for ATV
{
	...
	{
       R828_Arry[R828_Tuner_Num][11] |= 0x10; //b4=1
	   PLL_Ref = R828_Xtal /2;
	}
	else //DTV, FilCal, IMR
	{
       R828_Arry[R828_Tuner_Num][11] &= 0xEF;
	   PLL_Ref = R828_Xtal;
	}
}
else
{
	...
	R828_Arry[R828_Tuner_Num][13]    = (R828_Arry[R828_Tuner_Num][13] & 0x1F) | 0x80; 
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][13];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
	    return RT_Fail;
   ...
   VCO_fine_tune = (R828_I2C_Len.Data[4] & 0x30)>>4;
	...
	R828_I2C.RegAddr = 0x10;
	R828_Arry[R828_Tuner_Num][11] &= 0x1F;
	R828_Arry[R828_Tuner_Num][11] |= (DivNum << 5);
	R828_I2C.Data = R828_Arry[R828_Tuner_Num][11];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
/*
	if(DivNum==0)  //div=2
         R828_ExtraArry[R828_Tuner_Num][3]=0x07;   //PLL CPx2 on
	else
         R828_ExtraArry[R828_Tuner_Num][3]=0x06;   //PLL CPx2 off
*/
	...
	R828_Arry[R828_Tuner_Num][15]  = 0x00;
	R828_Arry[R828_Tuner_Num][15] |= (Ni + (Si << 6));
	R828_I2C.Data = R828_Arry[R828_Tuner_Num][15];
	...
	//pw_sdm	
	R828_I2C.RegAddr = 0x12;
	R828_Arry[R828_Tuner_Num][13] &= 0xF7;
	if(VCO_Fra == 0)
		R828_Arry[R828_Tuner_Num][13] |= 0x08;
	R828_I2C.Data = R828_Arry[R828_Tuner_Num][13];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	R828_Arry[R828_Tuner_Num][17]    = (UINT8) SDM16to9;
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][17];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	R828_I2C.RegAddr = 0x15;
	R828_Arry[R828_Tuner_Num][16]    = (UINT8) SDM8to1;
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][16];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
if ((Rafael_Chip==R620D) || (Rafael_Chip==R828D) || (Rafael_Chip==R828))
{
	...
	{
		R828_I2C.RegAddr = 0x12;
	    R828_Arry[R828_Tuner_Num][13]    = (R828_Arry[R828_Tuner_Num][13] & 0x1F) | 0x60;  //increase VCO current
        R828_I2C.Data    = R828_Arry[R828_Tuner_Num][13];
	    if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		     return RT_Fail;
	}
	...
	R828_I2C.RegAddr = 0x1A;
	R828_Arry[R828_Tuner_Num][21]    = R828_Arry[R828_Tuner_Num][21] | 0x08;
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][21];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
{	
	...
	R828_Arry[R828_Tuner_Num][18] = (R828_Arry[R828_Tuner_Num][18] & 0xF7) | Freq_Info1.OPEN_D;
	R828_I2C.Data = R828_Arry[R828_Tuner_Num][18];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	// RF_MUX,Polymux 
	R828_I2C.RegAddr = 0x1A;
	R828_Arry[R828_Tuner_Num][21] = (R828_Arry[R828_Tuner_Num][21] & 0x3C) | Freq_Info1.RF_MUX_PLOY;
	R828_I2C.Data = R828_Arry[R828_Tuner_Num][21];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	R828_Arry[R828_Tuner_Num][22] &= 0x00;
	R828_Arry[R828_Tuner_Num][22] |= Freq_Info1.TF_C;	
	R828_I2C.Data = R828_Arry[R828_Tuner_Num][22];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	// XTAL CAP & Drive
	R828_I2C.RegAddr = 0x10;
	R828_Arry[R828_Tuner_Num][11] &= 0xF4;
	switch(Xtal_cap_sel[R828_Tuner_Num])
	{
	   case XTAL_LOW_CAP_30P:
	   case XTAL_LOW_CAP_20P:
		   R828_Arry[R828_Tuner_Num][11] = R828_Arry[R828_Tuner_Num][11] | Freq_Info1.XTAL_CAP20P | 0x08;
		   break;

	   case XTAL_LOW_CAP_10P:
           R828_Arry[R828_Tuner_Num][11] = R828_Arry[R828_Tuner_Num][11] | Freq_Info1.XTAL_CAP10P | 0x08;
		   break;

	   case XTAL_LOW_CAP_0P:
		   R828_Arry[R828_Tuner_Num][11] = R828_Arry[R828_Tuner_Num][11] | Freq_Info1.XTAL_CAP0P | 0x08;
		   break;

	   case XTAL_HIGH_CAP_0P:
		   R828_Arry[R828_Tuner_Num][11] = R828_Arry[R828_Tuner_Num][11] | Freq_Info1.XTAL_CAP0P | 0x00;
		   break;
	...
	R828_Arry[R828_Tuner_Num][3] = R828_iniArry[3] & 0xC0;                   
	R828_Arry[R828_Tuner_Num][3] = R828_Arry[R828_Tuner_Num][3] | RT_Reg08;
	R828_I2C.Data = R828_Arry[R828_Tuner_Num][3];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;

	R828_I2C.RegAddr = 0x09;
	R828_Arry[R828_Tuner_Num][4] = R828_iniArry[4] & 0xC0;
	R828_Arry[R828_Tuner_Num][4] = R828_Arry[R828_Tuner_Num][4] | RT_Reg09;
	R828_I2C.Data =R828_Arry[R828_Tuner_Num][4]  ;
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
//	UINT8 IQ_Cunt  = 0;
	...
	{
		R828_I2C.RegAddr = 0x0C;
		R828_I2C.Data    = (R828_Arry[R828_Tuner_Num][7] & 0xF0) + VGA_Cunt;  
		if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
			return RT_Fail;
...
R828_ErrCode R828_GPIO(R828_TUNER_NUM_TYPE R828_Tuner_Num, R828_GPIO_Type R828_GPIO_Conrl)
{
	if(R828_GPIO_Conrl == HI_SIG)
		R828_Arry[R828_Tuner_Num][10] |= 0x01;
	else
		R828_Arry[R828_Tuner_Num][10] &= 0xFE;
...
{	 
	...
	if(RT_Standard != R828_pre_standard[R828_Tuner_Num])
	{
         for(ArrayNum=0;ArrayNum<27;ArrayNum++)
	    {
		    R828_Arry[R828_Tuner_Num][ArrayNum] = R828_iniArry[ArrayNum];
    ...
    R828_pre_standard[R828_Tuner_Num] = RT_Standard;

	// Record Init Flag & Xtal_check Result
	if(R828_IMR_done_flag[R828_Tuner_Num] == TRUE)
        R828_Arry[R828_Tuner_Num][7]    = (R828_Arry[R828_Tuner_Num][7] & 0xF0) | 0x01 | (Xtal_cap_sel[R828_Tuner_Num]<<1);
	else
	    R828_Arry[R828_Tuner_Num][7]    = (R828_Arry[R828_Tuner_Num][7] & 0xF0) | 0x00;
	...
	// Record version
	R828_I2C.RegAddr = 0x13;
	R828_Arry[R828_Tuner_Num][14]    = (R828_Arry[R828_Tuner_Num][14] & 0xC0) | VER_NUM;
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][14];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
	    return RT_Fail;
...
/*
	...
	if(RT_Standard > SECAM_L1)
	{
		...
		R828_I2C.Data = (R828_Arry[R828_Tuner_Num][24] & 0xC7) | 0x00;
	    if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		    return RT_Fail;
...
*/
	...
	// Set Filter Q
	R828_Arry[R828_Tuner_Num][5]  = (R828_Arry[R828_Tuner_Num][5] & 0xE0) | Sys_Info1.FILT_Q | R828_Fil_Cal_code[R828_Tuner_Num][RT_Standard];  
	R828_I2C.RegAddr  = 0x0A;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][5];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	R828_Arry[R828_Tuner_Num][6]= (R828_Arry[R828_Tuner_Num][6] & 0x10) | Sys_Info1.HP_COR;
	R828_I2C.RegAddr  = 0x0B;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][6];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	// Set Img_R
	R828_Arry[R828_Tuner_Num][2]  = (R828_Arry[R828_Tuner_Num][2] & 0x7F) | Sys_Info1.IMG_R;  
	R828_I2C.RegAddr  = 0x07;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][2];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	// Set filt_3dB, V6MHz
	R828_Arry[R828_Tuner_Num][1]  = (R828_Arry[R828_Tuner_Num][1] & 0xCF) | Sys_Info1.FILT_GAIN;  
	R828_I2C.RegAddr  = 0x06;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][1];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	R828_Arry[R828_Tuner_Num][25]  = (R828_Arry[R828_Tuner_Num][25] & 0x9F) | Sys_Info1.EXT_ENABLE;  
	R828_I2C.RegAddr  = 0x1E;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][25];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	//Loop through
	R828_Arry[R828_Tuner_Num][0]  = (R828_Arry[R828_Tuner_Num][0] & 0x7F) | Sys_Info1.LOOP_THROUGH;  
	R828_I2C.RegAddr  = 0x05;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][0];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	R828_Arry[R828_Tuner_Num][26]  = (R828_Arry[R828_Tuner_Num][26] & 0x7F) | Sys_Info1.LT_ATT;  
	R828_I2C.RegAddr  = 0x1F;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][26];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	R828_Arry[R828_Tuner_Num][10]  = (R828_Arry[R828_Tuner_Num][10] & 0x7F) | Sys_Info1.FLT_EXT_WIDEST;  
	R828_I2C.RegAddr  = 0x0F;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][10];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	R828_Arry[R828_Tuner_Num][20]  = (R828_Arry[R828_Tuner_Num][20] & 0x9F) | Sys_Info1.POLYFIL_CUR;  
	R828_I2C.RegAddr  = 0x19;
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][20];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
R828_ErrCode R828_Filt_Cal(R828_TUNER_NUM_TYPE R828_Tuner_Num, UINT32 Cal_Freq,BW_Type R828_BW)
{
	...
	if(R828_BW == BW_8M)
	{
		...
		R828_Arry[R828_Tuner_Num][6]   &= 0x9F;  //filt_cap = no cap
		R828_I2C.Data    = R828_Arry[R828_Tuner_Num][6];		
	}
	else if(R828_BW == BW_7M)
	{
		...
		R828_I2C.RegAddr = 0x0B;  //reg11
		R828_Arry[R828_Tuner_Num][6]   &= 0x9F;  //filt_cap = no cap
		R828_Arry[R828_Tuner_Num][6]   |= 0x20;  //filt_cap = +1 cap
		R828_I2C.Data    = R828_Arry[R828_Tuner_Num][6];		
	}
	else if(R828_BW == BW_6M)
	{
		...
		R828_I2C.RegAddr = 0x0B;  //reg11
		R828_Arry[R828_Tuner_Num][6]   &= 0x9F;  //filt_cap = no cap
		R828_Arry[R828_Tuner_Num][6]   |= 0x60;  //filt_cap = +2 cap
		R828_I2C.Data    = R828_Arry[R828_Tuner_Num][6];		
	}
...
*/
    ...
    // Set filt_cap
	R828_I2C.RegAddr  = 0x0B;
	R828_Arry[R828_Tuner_Num][6]= (R828_Arry[R828_Tuner_Num][6] & 0x9F) | (Sys_Info1.HP_COR & 0x60);
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][6];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	R828_Arry[R828_Tuner_Num][10]   |= 0x04;  //calibration clk=on
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][10];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	//Start Trigger
	R828_I2C.RegAddr = 0x0B;	//reg11
	R828_Arry[R828_Tuner_Num][6]   |= 0x10;	    //vstart=1	
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][6];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	//Stop Trigger
	R828_I2C.RegAddr = 0x0B;
	R828_Arry[R828_Tuner_Num][6]   &= 0xEF;     //vstart=0
	R828_I2C.Data    = R828_Arry[R828_Tuner_Num][6];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	...
	//set cali clk =off
	R828_I2C.RegAddr  = 0x0F;	//reg15
	R828_Arry[R828_Tuner_Num][10]    &= 0xFB;	//calibration clk=off
	R828_I2C.Data     = R828_Arry[R828_Tuner_Num][10];
	if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
R828_ErrCode R828_SetFrequency(R828_TUNER_NUM_TYPE R828_Tuner_Num, R828_Set_Info R828_INFO, R828_SetFreq_Type R828_SetFreqMode)
{
	...
	{
        R828_ExtraArry[R828_Tuner_Num][1]=0x31;  //ATSC: LNA 1.5dB on
		R828_ExtraArry[R828_Tuner_Num][2]=0xB8;  //ATSC: VGA comp on
	}
	else
	{
	    R828_ExtraArry[R828_Tuner_Num][1]=0x30; //others: off
		R828_ExtraArry[R828_Tuner_Num][2]=0xA8;  //others: VGA comp off
	}

	if(R828_INFO.RF_KHz<100000)
        R828_ExtraArry[R828_Tuner_Num][0]=0x80; //Q enhance on
	else
        R828_ExtraArry[R828_Tuner_Num][0]=0x00; //Q enhance off
	...
	for(i = 0;  i<5;  i++)
	{
		R828_I2C_Len.Data[i] = R828_ExtraArry[R828_Tuner_Num][i];
	}
	if(I2C_Write_Len(R828_Tuner_Num, &R828_I2C_Len) != RT_Success)
		return RT_Fail;
     ...
     R828_Arry[R828_Tuner_Num][24] = (R828_Arry[R828_Tuner_Num][24] & 0x38) | (SysFreq_Info1.LNA_TOP & 0xC7);
     R828_I2C.RegAddr = 0x1D;
     R828_I2C.Data = R828_Arry[R828_Tuner_Num][24];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
         return RT_Fail;

     // write MIXER TOP, TOP+-1
     R828_Arry[R828_Tuner_Num][23] = (R828_Arry[R828_Tuner_Num][23] & 0x07) | (SysFreq_Info1.MIXER_TOP & 0xF8); 
     R828_I2C.RegAddr = 0x1C;
     R828_I2C.Data = R828_Arry[R828_Tuner_Num][23];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
        return RT_Fail;
     ...
     // write LNA VTHL
     R828_Arry[R828_Tuner_Num][8] = (R828_Arry[R828_Tuner_Num][8] & 0x00) | SysFreq_Info1.LNA_VTH_L;
     R828_I2C.RegAddr = 0x0D;
     R828_I2C.Data = R828_Arry[R828_Tuner_Num][8];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
        return RT_Fail;

     // write MIXER VTHL
     R828_Arry[R828_Tuner_Num][9] = (R828_Arry[R828_Tuner_Num][9] & 0x00) | SysFreq_Info1.MIXER_VTH_L;
     R828_I2C.RegAddr = 0x0E;
     R828_I2C.Data = R828_Arry[R828_Tuner_Num][9];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
        return RT_Fail;

	 // Cable-1/Air in 
	 R828_I2C.RegAddr = 0x05;
	 R828_Arry[R828_Tuner_Num][0] &= 0x9F;
	 R828_Arry[R828_Tuner_Num][0] |= SysFreq_Info1.AIR_CABLE1_IN;	
	 R828_I2C.Data = R828_Arry[R828_Tuner_Num][0];
	 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	 ...
	 // Cable-2 in 
	 R828_I2C.RegAddr = 0x06;
	 R828_Arry[R828_Tuner_Num][1] &= 0xF7;
	 R828_Arry[R828_Tuner_Num][1] |= SysFreq_Info1.CABLE2_IN;	
	 R828_I2C.Data = R828_Arry[R828_Tuner_Num][1];
	 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
	 ...
	 R828_Arry[R828_Tuner_Num][12] &= 0xC7;
	 R828_Arry[R828_Tuner_Num][12] |= SysFreq_Info1.CP_CUR;	
	 R828_I2C.Data = R828_Arry[R828_Tuner_Num][12];
	 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		 return RT_Fail;	

	 //div buffer current and PLL current
	 R828_I2C.RegAddr = 0x17;
	 R828_Arry[R828_Tuner_Num][18] &= 0xC9;
	 R828_Arry[R828_Tuner_Num][18] |= SysFreq_Info1.DIV_BUF_CUR;
	 R828_I2C.Data = R828_Arry[R828_Tuner_Num][18];
	 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		 return RT_Fail;	
	 ...
	 R828_I2C.RegAddr  = 0x0A;
	 R828_Arry[R828_Tuner_Num][5]  = (R828_Arry[R828_Tuner_Num][5] & 0x9F) | SysFreq_Info1.FILTER_CUR;  
	 R828_I2C.Data     = R828_Arry[R828_Tuner_Num][5];
     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
         return RT_Fail;
	 ...
	 if(R828_INFO.R828_Standard > SECAM_L1)
	 {
		 ...
		 {
			 // write LNA TOP
			 R828_Arry[R828_Tuner_Num][24] = (R828_Arry[R828_Tuner_Num][24] & 0xC7) | (SysFreq_Info1.LNA_TOP & 0x38);
			 R828_I2C.RegAddr = 0x1D;
			 R828_I2C.Data = R828_Arry[R828_Tuner_Num][24];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				 return RT_Fail;
             
			 R828_Arry[R828_Tuner_Num][23] = (R828_Arry[R828_Tuner_Num][23] & 0xFB);  // 0: normal mode
			 R828_I2C.RegAddr = 0x1C;
			 R828_I2C.Data = R828_Arry[R828_Tuner_Num][23];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				return RT_Fail;
			 ...
			 // PRE_DECT on
			 R828_Arry[R828_Tuner_Num][1]  = (R828_Arry[R828_Tuner_Num][1] & 0xBF) | SysFreq_Info1.PRE_DECT;
			 R828_I2C.RegAddr  = 0x06;
			 R828_I2C.Data     = R828_Arry[R828_Tuner_Num][1];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				return RT_Fail;
			 ...
			 R828_Arry[R828_Tuner_Num][21]  = (R828_Arry[R828_Tuner_Num][21] & 0xCF) | 0x00;   			
			 R828_I2C.RegAddr  = 0x1A;
			 R828_I2C.Data     = R828_Arry[R828_Tuner_Num][21];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				return RT_Fail;

			 R828_Arry[R828_Tuner_Num][11]  = (R828_Arry[R828_Tuner_Num][11] & 0xFB) | 0x00;   			
			 R828_I2C.RegAddr  = 0x10;
			 R828_I2C.Data     = R828_Arry[R828_Tuner_Num][11];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				return RT_Fail;
             ...
             R828_Arry[R828_Tuner_Num][8] = (R828_Arry[R828_Tuner_Num][8] & 0x00) | 0x73;
             R828_I2C.RegAddr = 0x0D;
             R828_I2C.Data = R828_Arry[R828_Tuner_Num][8];
             if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
                 return RT_Fail;
		 ...
		 else  //NORMAL mode
		 {
			 ...
			 R828_Arry[R828_Tuner_Num][23] = (R828_Arry[R828_Tuner_Num][23] & 0xFB) | (SysFreq_Info1.MIXER_TOP & 0x04); 
			 R828_I2C.RegAddr = 0x1C;
			 R828_I2C.Data = R828_Arry[R828_Tuner_Num][23];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				return RT_Fail;
			 ...
			 R828_Arry[R828_Tuner_Num][25]  = (R828_Arry[R828_Tuner_Num][25] & 0xE0) | SysFreq_Info1.LNA_DISCHARGE;  
			 R828_I2C.RegAddr  = 0x1E;
			 R828_I2C.Data     = R828_Arry[R828_Tuner_Num][25];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				return RT_Fail;
			 ...
			 //agc clk 60hz 
			 R828_Arry[R828_Tuner_Num][21]  = (R828_Arry[R828_Tuner_Num][21] & 0xCF) | 0x20;   	
			 R828_I2C.RegAddr  = 0x1A;
			 R828_I2C.Data     = R828_Arry[R828_Tuner_Num][21];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				return RT_Fail;

			 R828_Arry[R828_Tuner_Num][11]  = (R828_Arry[R828_Tuner_Num][11] & 0xFB) | 0x04;   			
			 R828_I2C.RegAddr  = 0x10;
			 R828_I2C.Data     = R828_Arry[R828_Tuner_Num][11];
			 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
				return RT_Fail;
...
R828_ErrCode R828_RfGainMode(R828_TUNER_NUM_TYPE R828_Tuner_Num, R828_RF_Gain_TYPE R828_RfGainType)
{
	...
	if(R828_RfGainType==RF_MANUAL)
	{
		//LNA auto off
	     R828_I2C.RegAddr = 0x05;
	     R828_Arry[R828_Tuner_Num][0] = R828_Arry[R828_Tuner_Num][0] | 0x10;
		 R828_I2C.Data = R828_Arry[R828_Tuner_Num][0];
	     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		       return RT_Fail;
		...
		//set LNA gain
	     R828_I2C.RegAddr = 0x05;
	     R828_Arry[R828_Tuner_Num][0] = (R828_Arry[R828_Tuner_Num][0] & 0xF0) | LnaGain;
		 R828_I2C.Data = R828_Arry[R828_Tuner_Num][0];
	     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		       return RT_Fail;
		 ...
		 //set Mixer gain
	     R828_I2C.RegAddr = 0x07;
	     R828_Arry[R828_Tuner_Num][2] = (R828_Arry[R828_Tuner_Num][2] & 0xF0) | MixerGain;
		 R828_I2C.Data = R828_Arry[R828_Tuner_Num][2];
	     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		       return RT_Fail;
	}
	else
	{
	    //LNA
	     R828_I2C.RegAddr = 0x05;
	     R828_Arry[R828_Tuner_Num][0] = R828_Arry[R828_Tuner_Num][0] & 0xEF;
		 R828_I2C.Data = R828_Arry[R828_Tuner_Num][0];
	     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		       return RT_Fail;
		 ...
		 //Mixer
	     R828_I2C.RegAddr = 0x07;
	     R828_Arry[R828_Tuner_Num][2] = R828_Arry[R828_Tuner_Num][2] | 0x10;
		 R828_I2C.Data = R828_Arry[R828_Tuner_Num][2];
	     if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		       return RT_Fail;
	}
...
R828_ErrCode R828_SetLoopThrough(R828_TUNER_NUM_TYPE R828_Tuner_Num, R828_LoopThrough_Type R828_LT_Type)
{
	...
	{
         R828_Arry[R828_Tuner_Num][0] = (R828_Arry[R828_Tuner_Num][0] & 0x7F) | 0x00;  
		 //R828_Arry[R828_Tuner_Num][26] = (R828_Arry[R828_Tuner_Num][26] & 0x7F) | 0x00;   
	}
	else
	{
		 R828_Arry[R828_Tuner_Num][0] = (R828_Arry[R828_Tuner_Num][0] & 0x7F) | 0x80;  
		 //R828_Arry[R828_Tuner_Num][26] = (R828_Arry[R828_Tuner_Num][26] & 0x7F) | 0x80;  
	}
...
R828_ErrCode R828_SetLoopThroughAttenu(R828_TUNER_NUM_TYPE R828_Tuner_Num, R828_LoopThroughAtt_Type R828_LT_Att_Type, UINT8 R828_LT_Att_Gain)
{
    if(R828_LT_Att_Type == LT_ATT_ON)
	{
		 R828_Arry[R828_Tuner_Num][26] = (R828_Arry[R828_Tuner_Num][26] & 0x7F) | 0x00;   //ON
	}
	else
	{
		 R828_Arry[R828_Tuner_Num][26] = (R828_Arry[R828_Tuner_Num][26] & 0x7F) | 0x80;  //OFF
	}
	 ...
	 //LT Att Gain
	 R828_ExtraArry[R828_Tuner_Num][2] =  ((R828_ExtraArry[R828_Tuner_Num][2] & 0xF8) | R828_LT_Att_Gain);
	 R828_I2C.RegAddr  = 0x02;
	 R828_I2C.Data     = R828_ExtraArry[R828_Tuner_Num][2];
	 if(I2C_Write(R828_Tuner_Num, &R828_I2C) != RT_Success)
		return RT_Fail;
...
HI_S32 r820c_set_tuner(HI_U32 u32TunerPort, HI_U8 i2c_channel, HI_U32 puRF)
{
    ...
    {
        R828_Standard_Set=DVB_C_6M_5070;
        R828_Info_Msg.R828_Standard=DVB_C_6M_5070;
    }
    else
    {
